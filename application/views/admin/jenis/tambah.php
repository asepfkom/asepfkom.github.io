...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" name="nama_jenis" class="form-control" placeholder="Nama" value="<?php echo set_value('nama_jenis')?>" required>
	</div>
	<div class="form-group">
		<label>Kode Jenis Buku</label>
		<input type="text" name="kode_jenis" class="form-control" placeholder="Kode Jenis" value="<?php echo set_value('kode_jenis')?>" required>
	</div>
	<div class="form-group">
