        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                	...
                	<input type="number" name="urutan" class="form-control" placeholder="Urutan File" required="required" value="<?php echo set_value('urutan')?>">
                </div>
                <div class="form-group">
                	<label>Keterangan</label>
                	<textarea name="keterangan" class="form-control" placeholder="Keterangan"><?php echo set_value('judul_file')?></textarea>
                </div>
            </div>
